...
> = {
  ...
  cline: {
    requestQuota: 'The Cline ACP runtime does not report request quotas to the host.',
    quotaWindows: 'Rolling usage windows are not reported by this provider.',
    costEstimate: 'Cost is not reported by this provider.',
    compaction: 'Compaction events are not reported by this provider.',
    thinkingTokens: 'Thinking-token counts are not itemised by this provider.',
    retries: 'Retry attempts are not reported by this provider.',
  },
  opencode: {
    requestQuota: 'The OpenCode ACP runtime does not report request quotas to the host.',
    quotaWindows: 'Rolling usage windows are not reported by this provider.',
    costEstimate: 'Cost is not reported by this provider.',
    compaction: 'Compaction events are not reported by this provider.',
    thinkingTokens: 'Thinking-token counts are not itemised by this provider.',
  ...
  codex: {
    requestQuota: 'The Codex runtime does not report request quotas to the host.',
    quotaWindows: 'Rolling usage windows are not reported by this provider.',
    costEstimate: 'Cost is not reported by this provider.',
    compaction: 'Compaction events are not reported by this provider.',
